...
$maxPrice = !empty($prices) ? max($prices) : 100;
...
// Filter products by category, search, and price if specified
$filteredProducts = $products;
$selectedCategory = '';
$searchQuery = '';
$priceFilter = isset($_GET['price']) ? floatval($_GET['price']) : $maxPrice;
...
$filteredProducts = array_filter($products, function($product) use ($selectedCategory, $searchQuery, $priceFilter) {
    ...
    $matchesPrice = floatval($product['price']) <= $priceFilter;
...
<body>
    ...
    <main class="container">
        ...
        <div class="products-content">
            <?php if (!empty($selectedCategory) || !empty($searchQuery)): ?>
                <h2 style="text-align: center; margin-bottom: 30px; color: #333;">
                    ...
                    ?>
                    <span style="font-size: 0.8em; color: #666;">(<?php echo count($filteredProducts); ?> produits)</span>
                </h2>
            <?php endif; ?>
            ...
            <?php foreach ($filteredProducts as $product): ?>
                <div class="product-card">
                    ...
                    <button href="product_view.php?id=<?php echo $product['id']; ?>" class="product-link"></button>
                     </form>
    ...
    <script>
        // Enhanced sidebar functionality with button-based filtering
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function filterProducts() {
                ...
                // Update page title
                updatePageTitle(selectedCategory, filtered.length);
            ...
            function updateProductsGrid(products) {
                ...
                if (products.length === 0) {
                    productsGrid.innerHTML = '<div class="no-products"><p>Aucun produit trouvé.</p></div>';
                    return;
                }
                ...
                products.forEach(product => {
                    ...
                    productCard.innerHTML = `
                        <form method="get" action="product_view.php">
                            ...
                            <button href="product_view.php?id=${product.id}" class="product-link"></button>
                        </form>
                        ...
                        <div class="product-info">
                            ...
                            <p class="price">${parseFloat(product.price).toFixed(2)} DT</p>
                            <div class="stock-status"> 
                                ${product.stock > 0 ? '<span class="in-stock">En stock</span>' : '<span class="out-of-stock">Épuisé</span>'}
                            </div>
                            <div class="options">
                                <a href="product_view.php?id=${product.id}" class="view-details-btn">Voir détails</a>
            ...
            // Update page title
            function updatePageTitle(category, count) {
                if (!pageTitle) return;

                if (category) {
                    pageTitle.textContent = `Produits ${category.charAt(0).toUpperCase() + category.slice(1)} (${count})`;
            ...
            const activeFiltersDivMobile = document.getElementById('active-filters-mobile');
            const filterTagsDivMobile = document.getElementById('filter-tags-mobile');
